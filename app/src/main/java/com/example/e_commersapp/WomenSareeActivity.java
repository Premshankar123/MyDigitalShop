...
public class WomenSareeActivity extends AppCompatActivity {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/WomenSareeApi.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_saree);
       recyclerView=(RecyclerView)findViewById(R.id.women_saree_recycle);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        detail.add(mydetail);
                        adapter = new WomenSareeRecycleAdapter(detail, WomenSareeActivity.this);
