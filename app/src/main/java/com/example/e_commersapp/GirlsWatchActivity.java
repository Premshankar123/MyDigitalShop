...
public class GirlsWatchActivity extends AppCompatActivity {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/GirlsWatchApi.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girls_watch);
        recyclerView=(RecyclerView)findViewById(R.id.girls_recycle_view);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        detail.add(mydetail);
                        adapter = new WomenSareeRecycleAdapter(detail, GirlsWatchActivity.this);
