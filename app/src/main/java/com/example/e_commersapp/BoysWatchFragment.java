...
public class BoysWatchFragment extends Fragment {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/BoysWatchFragmentApi.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_boys_watch, container, false);
        recyclerView=(RecyclerView)root.findViewById(R.id.boys_watch_recycle);
        ...
        viewAll_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getContext(),BoysWatchActivity.class);
