...
public class Veri_Pct_Fragment extends Fragment {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/product1.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_veri__pct_, container, false);
        recyclerView=(RecyclerView)root.findViewById(R.id.veri_pct_recycle);
