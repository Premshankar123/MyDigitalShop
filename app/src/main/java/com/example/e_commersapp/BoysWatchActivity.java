...
public class BoysWatchActivity extends AppCompatActivity {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/BoysWatchApi.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boys_watch);
        recyclerView=(RecyclerView)findViewById(R.id.boys_watch_recycle);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        detail.add(mydetail);
                        adapter = new WomenSareeRecycleAdapter(detail, BoysWatchActivity.this);
