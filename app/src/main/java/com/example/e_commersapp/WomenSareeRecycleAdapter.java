...
public class WomenSareeRecycleAdapter extends RecyclerView.Adapter<WomenSareeRecycleAdapter.MyViewHolder> {
    ...
    public WomenSareeRecycleAdapter(List<WomenSareeDetails> detail, Context context) {
        this.detail = detail;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.women_saree_str,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.img.setOnClickListener(new View.OnClickListener() {
            ...
            public  void onClick(View v) {
                final  WomenSareeDetails data= detail.get(position);
                ...
                Intent intent=new Intent(context,WomenSareeProductBye.class);
