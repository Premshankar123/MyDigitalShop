...
public class Girls_watch_fragment extends Fragment {
    String JSON_URL="https://unreposeful-rheosta.000webhostapp.com/GirlsWatchFragmentApi.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_girls_watch_fragment, container, false);
        recyclerView=(RecyclerView)root.findViewById(R.id.girls_watch_recycle);
        ...
        viewAll_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getContext(),GirlsWatchActivity.class);
